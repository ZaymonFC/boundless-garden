...
export const id = "487be66f-5714-4490-80a4-9cbecc93d750";
export const meta = {
  id: id,
  title: "Momentum 1",
...
I find it much easier to keep working or push myself if I've got momentum behind me. Focussing when I'm in the swing of things is a breeze.
...
2021 has been the first year that I have been able to effectively direct long-term, sustained effort into *any* project.
...
According to *The Art of Impossible* it all starts with **intrinsic motivation**<Inline citation="art-of-impossible"/>.
...
Recently I've been finding a lot of satisfaction in synthesising written works. So here we are.
...
Understanding myself, and what makes me tick, makes me effective might take years.
