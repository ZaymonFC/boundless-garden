...
Enter __Roam Research__. Roam is a note-taking tool that lets you create a network of information. The application completely abandons the broken filing cabinet metaphor, letting you reference any page from any other. You're never stuck working out where a piece of information belongs it can stand on its own.
Roam Research, and its emerging competition are taking Vannevar Bush's ideas for 'the memex', Wikipedias idea's for indexing knowledge and remixing them into a new __tool for thought__.
...
### Loss of information
We are too accustomed to the __impermanence__ of information. I've never seen an instant messaging app that's optimised for storing, archiving and retrieving information from a conversation.
Messages are __obliterated__ into the void under the deluge of new ones.
Popular platforms like Slack —a successful app for internal communication— emphasise the **ephemerality** of information. How much context are we *losing*? How much time are we *wasting* **re-seeking** instead of using effective archival retrieval?
