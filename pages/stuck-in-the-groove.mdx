...
<BlogImage
  src={stuckInTheGroove}
  alt="Stuck in the Groove - Stable Diffusion 2.0"
  caption={"Stuck in the Groove - Stable Diffusion 2.0"}
/>
...
However, I'm realising that I _have_ started filling the gaps, and one of the big ways I'm doing so is writing this blog consistently.
I need to mentally frame writing for Boundless Garden as a **_real project_**.
...
It's been so long since I did _anything_ physical for more than a couple consecutive days.
...
I often feel that I only have so much time in my life and that it's really important that I pick the _right_ things to invest time into learning.
This is a fallacy.
Our lives are finite, but I used to be much more open to learning about anything that draws my curiosity.
Who cares if it _might_ impact some other learning especially when the result of this attitude is deciding to learn nothing at all because I can't convince myself that anything is _important enough_.
...
I need to learn to approach new things with a lower perceived degree of importance and believe that just being curious about something then satisfying that curiosity _is enough_.
I don't have to learn things because they are _important_.
Important to who!?
